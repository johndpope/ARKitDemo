...
class MessageManager {
    ...
    private func showMessage(_ text: String, autoHide: Bool = true) {
        timer?.invalidate()
        ...
        if autoHide {
            ...
            timer = Timer.scheduledTimer(withTimeInterval: displayDuration, repeats: false, block: { [weak self] _ in
